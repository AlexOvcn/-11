...
@section('content')
    <div class="container">
        <form class="addNewsForm" action="{{route('layouts.creatingNews')}}" method="POST">
            ...
            <label class="addNewsForm-label"><span class="addNewsForm-label__title">Article: </span><textarea name="full_text"  rows="20" class="addNewsForm-label__input" oninput="inputRestriction(5000, this)"  required minlength='2'></textarea></label>
